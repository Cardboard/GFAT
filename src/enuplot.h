...
public:
    ENUPlot();
    ENUPlot(CompMan *cm, ofVec2f *pt, string label_plot, string label_x, string label_y);
    ...
    void draw();
    void drawPlot(ofRectangle *rect, vector<DataPt> *data, float x_min, float x_max, float y_min, float y_max, float yscale, string label);
